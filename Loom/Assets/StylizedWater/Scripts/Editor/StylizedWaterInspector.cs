...
namespace StylizedWaterShader
{
    ...
    public class StylizedWaterInspector : Editor
    {
            ...
            if (EditorGUILayout.BeginFadeGroup(m_showLighting.faded))
            {
                ...
                switch (lightingMethod.intValue)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        EditorGUILayout.HelpBox("Material uses all Unity lighting features except point/spot lights", MessageType.None);
                        break;
                }
                if (showHelpLighting) EditorGUILayout.HelpBox("Advanced lighting enables lighting features such as GI, glossiness and skybox reflection. Turning this off can be a huge performance saver on low-end devices\n\nSimple lighting uses a custom lighting model with ambient light color and sun reflection.", MessageType.Info);
            ...
            if (EditorGUILayout.BeginFadeGroup(m_showSurface.faded))
            {
                ...
                */
                ...
                if (lightingMethod.intValue == 2)
                {
                    ...
                    if (showHelpSurface) EditorGUILayout.HelpBox("Determine how conductive the surface is. Slight metalic values can enhance the reflective nature of the water", MessageType.Info);
                }
        ...
        void DoFooter()
        {
            ...
            if (StylizedWaterCore.IS_UPDATED == false)
            {
